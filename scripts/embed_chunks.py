...
Aufruf: uv run python scripts/embed_chunks.py [--project BAU-42] [--neu]
"""
...
from bauprojekt.db import connect, init_schema, reset_schema
...
def main() -> None:
    ...
    parser.add_argument(
        "--neu",
        action="store_true",
        help="Tabelle löschen und alle Chunks neu einbetten (nach Änderungen am Schema)",
    )
